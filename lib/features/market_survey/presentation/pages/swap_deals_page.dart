          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'This is a sample swap deal post content. '
                  'It contains details about what I\'m offering and looking for.',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Post Content
                Text(
                  'Looking to swap my collection of books for electronics. Have 200+ technical books in excellent condition.',
                  style: Theme.of(context).textTheme.bodyMedium,
                ),
  ...
  void _showCreatePostDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Create Swap Deal Post'),
        content: Column(
          ...
          children: [
            ...
            const TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Describe what you are offering and looking for',
              ),
            ),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Swap Deal post created')),
              );
            },
