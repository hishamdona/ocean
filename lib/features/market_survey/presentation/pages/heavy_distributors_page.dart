              ...
              children: [
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'My Heavy Distributor Post $index',
                ...
                Text(
                  'This is a sample heavy distributor post content. '
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Post Content
                Text(
                  'Major distributor of home appliances. Wholesale prices available. Minimum order 100 units.',
                  style: Theme.of(context).textTheme.bodyMedium,
                ),
  ...
  void _showCreatePostDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Create Heavy Distributor Post'),
        content: Column(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Heavy Distributor post created')),
              );
            },
